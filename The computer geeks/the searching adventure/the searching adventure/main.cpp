...
char image1Path []="/Users/Moody/Documents/CG-lab/CG-project/floor-texture-2-.bmp"; // walls
char image2Path []="/Users/Moody/Documents/CG-lab/CG-project/floor-texture-2-.bmp"; // floor
...
//     glColor4f(0.07f, 0.07f, 0.07f, 1.0f);
...
//    if (start == true ) {
//        glClearColor(1.0, 1.0, 1.0, 0.1); // Set background color to White and opaque
//        glMatrixMode(GL_PROJECTION);
//    }
//
//    if (HH == true ) {
//    else if (HH == true ) {
        ...
        //------- Texture 2 - floor ---------
        myTexture2 = LoadTexture(image2Path, 626,626);
        ...
        glClearColor(1.0, 1.0, 1.0,1.0f); // set background color
